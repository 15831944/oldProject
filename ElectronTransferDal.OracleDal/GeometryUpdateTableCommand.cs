...
using Geometry =SpatialAnalysis.Geometry;

namespace ElectronTransferDal.OracleDal
{
    internal class GeometryUpdateTableCommand : GeometryCommand
    {
        public GeometryUpdateTableCommand(ElectronSymbol entity, SimpleMapping mapping, RDBManagerBase dbManager,DbConnection conn)
        ...
        public override bool Execute()
        {
            ...
            //    dbManager.RevealedRunsurrounds(Surrounds,conn);
                ...
                var geometryQueryBuilder = new UpdateSdoGeometryQueryBuilder(Entity, AvoidFieldsCache.Instance.GetNonColumnFields(Entity.GetType()), Mapping);
